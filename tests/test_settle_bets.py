...
class TestParseBetLine:
    ...
    def test_team_with_apostrophe(self):
        ...
        assert result == {"team": "St. John's", "spread": 4.5, "side": None, "bet_type": "spread"}
...
class TestDetermineBetResult:
    ...
    def test_standard_spread_win(self):
        ...
        parsed = {"team": "Providence", "spread": 15.5, "side": None, "bet_type": "spread"}
        game = {
            "home_score": 85,
            "away_score": 75,
            "home_name": "UConn",
    ...
    def test_standard_spread_loss(self):
        ...
        parsed = {"team": "Providence", "spread": 5.5, "side": None, "bet_type": "spread"}
        game = {
            "home_score": 85,
            "away_score": 75,
            "home_name": "UConn",
    ...
    def test_standard_spread_push(self):
        ...
        parsed = {"team": "Providence", "spread": 10.0, "side": None, "bet_type": "spread"}
        game = {
            "home_score": 85,
            "away_score": 75,
            "home_name": "UConn",
    ...
    def test_favorite_covers(self):
        ...
        parsed = {"team": "Duke", "spread": -5.5, "side": None, "bet_type": "spread"}
        game = {
            "home_score": 80,
            "away_score": 70,
            "home_name": "Duke",
    ...
    def test_favorite_fails_to_cover(self):
        ...
        parsed = {"team": "Duke", "spread": -15.5, "side": None, "bet_type": "spread"}
        game = {
            "home_score": 80,
            "away_score": 70,
            "home_name": "Duke",
    ...
    def test_kalshi_yes_win(self):
        ...
        parsed = {"team": "UConn", "spread": -15.5, "side": "YES", "bet_type": "spread"}
        game = {
            "home_score": 95,
            "away_score": 75,
            "home_name": "UConn",
    ...
    def test_kalshi_no_win(self):
        ...
        parsed = {"team": "UConn", "spread": -15.5, "side": "NO", "bet_type": "spread"}
        game = {
            "home_score": 85,
            "away_score": 75,
            "home_name": "UConn",
    ...
    def test_kalshi_exact_threshold_void(self):
        ...
        parsed = {"team": "UConn", "spread": -15.0, "side": "YES", "bet_type": "spread"}
        game = {
            "home_score": 90,
            "away_score": 75,
            "home_name": "UConn",
    ...
    def test_unknown_team_returns_none(self):
        ...
        parsed = {"team": "Unknown", "spread": 5.5, "side": None, "bet_type": "spread"}
        game = {
            "home_score": 80,
            "away_score": 70,
            "home_name": "Duke",
